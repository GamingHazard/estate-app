...
type AdminScreens = keyof Pick<RootStackParamList, 
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        {!isCollapsed && <View style={styles.badge}>
      ...
      {menuItems.map((item, index) => (
        <TouchableOpacity
          ...
          onPress={() => {navigation.navigate(item.screen), onToggleCollapse() }} // Auto expand on navigation if collapsed
        >
