    ...
    >
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          This manual provides comprehensive guidance on using the admin
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          The admin dashboard gives you complete control over property listings,
      ...
      <View style={styles.section}>
        ...
        <View style={styles.bulletPoint}>
          <Text style={styles.bullet}>•</Text>
          <Text style={styles.bulletText}>
            Review, edit, or remove property listings from the Properties
            Management section
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Monitor key metrics and performance indicators through the Analytics
          dashboard:
        </Text>
        <View style={styles.bulletPoint}>
          <Text style={styles.bullet}>•</Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Contact our support team for technical assistance or questions about
          the admin dashboard.
        </Text>
      </View>
    </ScrollView>
