  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text
          style={{ color: theme === "dark" ? "white" : "black", marginTop: 10 }}
        >
          Full Name
        </Text>
        <Text style={{ color: colors.textMuted, marginTop: 5, fontSize: 16 }}>
          User Name
        </Text>
        ...
        >
          <Text
            style={{ color: colors.textMuted, fontSize: 16, marginRight: 10 }}
          >
            User Email{" "}
          </Text>
          <Text
      ...
      >
        ...
        <TextInput
          style={[
            styles.input,
            { backgroundColor: "pink", color: colors.text },
          ]}
