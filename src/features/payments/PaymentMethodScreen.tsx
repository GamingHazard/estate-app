...
const PaymentMethodScreen = ({ navigation }: Props) => {
  ...
  const paymentMethods = [
    ...
    },
    {
      ...
      title: "Mobile Money",
      icon: (color: string) => (
        <FontAwesome5 name="mobile-alt" size={24} color={color} />
      ),
    ...
    },
    {
      ...
      icon: (color: string) => (
        <FontAwesome5 name="bitcoin" size={24} color={color} />
      ),
        ...
        {paymentMethods.map((method) => (
          <TouchableOpacity
            ...
            style={[
              styles.methodCard,
              {
                ...
                borderColor:
                  selectedMethod === method.id ? colors.primary : colors.border,
              },
            ]}
          ...
          >
            <View style={styles.methodHeader}>
              {method.icon(
                selectedMethod === method.id ? colors.primary : colors.text,
              )}
