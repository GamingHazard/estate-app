...
import { RootStackParamList, NavigationProp } from "../../shared/types";
// import { Colors } from "react-native/Libraries/NewAppScreen"; // Removed obsolete import
    ...
    >
      ...
      >
        ...
        <Text style={[styles.price, { color: colors.primary }]}>
          ...
          {property.type.includes("Apartment") ||
          property.type.includes("Space")
            ? " / month"
            : ""}
        </Text>
        ...
        <View style={styles.otherImagesContainer}>
          {property.gallery.map((image, index) => (
            ...
            >
              ...
              />
              <Text style={[styles.otherImageName, { color: colors.text }]}>
                {image.name}
              </Text>
            </TouchableOpacity>
          ))}
