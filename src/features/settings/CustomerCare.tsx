...
const faqs = [
  {
    ...
    answer:
      "Go to Account Settings > Account Recovery and follow the instructions to reset your password.",
  },
  {
    question: "How can I contact customer support?",
    answer:
      "You can reach us via email at support@estateapp.com or call our hotline at 1-800-ESTATE.",
  },
  {
    question: "How do I update my profile information?",
    answer:
      "Navigate to Profile > Edit Profile and update your information as needed.",
  },
  {
    question: "Where can I find my saved properties?",
    answer:
      "Go to the Saved tab from the main navigation to view all your saved properties.",
  },
  {
    question: "How do I enable notifications?",
    answer:
      "Visit Application Settings and toggle the notifications switch to enable or disable notifications.",
  },
];
    ...
    >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.formGroup}>
          ...
          <TouchableOpacity
            style={[styles.submitButton, { backgroundColor: colors.bg }]}
